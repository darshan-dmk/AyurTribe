-- ===================================================================
-- New schema.sql (Universal Order - Users & Profiles FIRST)
-- ===================================================================
...
-- ===================================================================
-- 1. USERS (Base Table for everything)
-- ===================================================================
...
create table public.health_metrics (
  ...
  constraint health_metrics_user_id_fkey foreign KEY (user_id) references users (id) on delete CASCADE
) TABLESPACE pg_default;
...
create table public.medical_history (
  ...
  constraint medical_history_user_id_fkey foreign KEY (user_id) references users (id) on delete CASCADE
) TABLESPACE pg_default;
...
create table public.prakriti_assessments (
  ...
  constraint prakriti_assessments_user_id_fkey foreign KEY (user_id) references users (id) on delete CASCADE
) TABLESPACE pg_default;
...
create policy "Service role can do anything" on public.users as permissive for all using (current_setting('role') = 'postgres' or current_setting('role') like 'service_role%');
